...
class DeepVARNetwork(mx.gluon.HybridBlock):
    ...
    def distr(
        ...
        # print('distr args:',distr_args)
        # print('distr args T:',type(distr_args))
        # print('distr args sh:',distr_args[0].shape)
        # print('distr args sh:',distr_args[0])
    ...
    def sampling_decoder(
        ...
        if len(samples.shape)>2:
            if samples.shape[2]==207:
                print('aa gya')
                agg_traffic = pd.read_csv('hyp_param_tuning/agg_traffic.csv')
                ...
                Hierarchy_SAMPLES=np.matmul(bottom_samples,AG.T)
                total_samples=np.concatenate((Hierarchy_SAMPLES,bottom_samples),axis=2)
